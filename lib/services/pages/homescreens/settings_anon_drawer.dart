...
class SettingsFormAnonDrawer extends StatefulWidget {
  @override
  _SettingsFormAnonDrawerState createState() => _SettingsFormAnonDrawerState();
}
            ...
            child: Row(
              ...
              children: <Widget>[
                Text(
                  'REGISTER  ',
                  style: TextStyle(
                      color: Colors.white, letterSpacing: 1.5, fontSize: 18.0),
                ),
                Icon(
                  Icons.person_add,
                  color: Colors.white,
